...
//
// At `deriving` we either generate a fresh 24-word BIP-39 mnemonic
// (Create) or accept the imported phrase verbatim after BIP-39
...
export function Onboarding({ onDone }: Props) {
  ...
  const submitImport = () => {
    ...
    if (wordCount !== MNEMONIC_WORDS) {
      setImportError(
        `Expected ${MNEMONIC_WORDS} words, got ${wordCount}. Recovery phrases are exactly 24 words.`,
      );
      return;
    }
    try {
      ...
      <div className="mw-scroll">
          ...
          <>
            ...
            <div className="mw-card">
              ...
              <div className="mw-kv">
                ...
                <div className="v">24-word recovery phrase</div>
              </div>
            </div>
          ...
          <>
            <div className="mw-card">
              ...
              >
                ...
                spaces or line breaks. Standard 24-word BIP-39 phrases are
                accepted.
              </p>
              <textarea
                autoFocus
        ...
        {step === "deriving" && (
          <div className="mw-card mw-auth">
            ...
            >
              Argon2id · 32 MiB · t=2 · ML-DSA-65. This runs entirely
              on this device.
            </div>
          </div>
        )}
        ...
        {step === "show-phrase" && mnemonic && (
          <>
            <div className="mw-card">
              ...
              >
                This recovery phrase is the only recovery path. Write it down
